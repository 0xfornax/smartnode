...
// Creates a new page for the Rescue Node addon settings
func NewAddonRnPage(addonsPage *AddonsPage, addon addons.SmartnodeAddon) *AddonRnPage {

	configPage := &AddonRnPage{
		addonsPage:   addonsPage,
...
func (configPage *AddonRnPage) getPage() *page {
	return configPage.page
}

// Creates the content for the RN settings page
func (configPage *AddonRnPage) createContent() {
...
func (configPage *AddonRnPage) handleEnableChanged() {
...
func (configPage *AddonRnPage) handleLayoutChanged() {
	configPage.handleEnableChanged()
}
